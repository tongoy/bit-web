The script is used to get [BIT](https://www.bit.edu.cn/) [network connection](http://10.0.0.55/) when desktop environment is unavailable.
...
### Logout
Run `python3 client2.py -u stuid -p password -a logout`.
